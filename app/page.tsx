...
const SOLUTIONS: {
...
}[] = [
  {
    ...
    tag: "PROXIMA",
    title: "미디어 자산 관리",
    desc: "콘텐츠가 들어오는 순간부터 변환·보관·분석·배포까지, 소프트웨어 코덱·NLE 연동 기반 미디어 자산 관리",
  },
  {
    num: "02",
    tag: "ZODIAC",
    title: "뉴스룸 (NRCS)",
    desc: "뉴스 기획·기사 작성·큐시트 구성·송출까지, PC와 모바일에서 하나로 이어지는 뉴스룸 업무 흐름 연결",
  },
  {
    num: "03",
    tag: "TALOS",
    title: "자동 송출 (APC)",
    desc: "편성 스케줄 관리와 비디오 서버 제어를 하나의 APC 시스템으로 자동화하는 안정적 온에어 운영 지원",
  },
  {
  ...
  },
  {
    ...
    tag: "WINNER-S",
    title: "라디오",
    desc: "네트워크·대용량 데이터베이스 기반으로 9개 단말 환경을 연결하는 라디오 운영·오디오 자산 관리",
  },
  {
    num: "06",
    tag: "MAIA",
    title: "AI 기술",
    desc: "미디어를 위한 AI — 방송 데이터 기반 메타데이터·자막·동적 보정 지원과 검색 가능한 미디어 자산화",
  },
  {
    num: "07",
    tag: "MYMY",
    title: "콘텐츠 아카이브",
    desc: "계속 쌓이는 미디어 라이브러리의 안정적 보관과 빠른 검색을 지원하는 장기 디지털·영상 아카이브",
  },
  {
    num: "08",
    tag: "G-SAM",
    title: "콘텐츠 배포",
    desc: "콘텐츠 하나로 YouTube·Instagram·X까지, 멀티 플랫폼 콘텐츠 배포·성과 데이터 관리 시스템",
  },
];
