...
export const MISSION_PILLARS: MissionPillar[] = [
  {
    ...
    title: ["사람을", "연결하다"],
    lead:
      "제머나이소프트가 개발하는 기술을 통해 사람들을 연결하고,\n공동체를 만들겠다는 의지를 보여줍니다.",
    body:
  ...
  },
  {
    ...
    title: ["장소를", "연결하다"],
    lead:
      "미디어를 통해 서로 다른 장소와 다른 문화에 있는 사람들이\n문화, 아이디어, 경험을 확장하고 공유할 수 있을 것이라는\n우리의 믿음을 보여줍니다.",
    body:
      "우리는 지리적 경계를 극복하여, 한 장소에서 다른 장소로 문화와 콘텐츠를 전파하는 기술을 제머나이소프트가 개발할 수 있을 것이라고 믿고 도전하고 있습니다. 미디어를 통해 우리는 새로운 문화적 경험과 가치를 얻을 수 있고 전달할 수 있습니다. 그리고 서로의 세계에 대한 좀 더 나은 통찰력을 제공하여 다양한 장소에 있는 사람들을 연결할 수 있을 것입니다. 우리가 만드는 미디어 기술을 통해 물리적 경계를 초월하고, 다양한 지역에서 다양한 문화와 관점을 공유하고 감상할 수 있는 글로벌 연결을 만들 수 있도록 최선을 다하겠습니다.",
    diagram: "places",
